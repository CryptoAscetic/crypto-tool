...
def send_telegram_message(message, tokenAddress, tokenSymbol):
    ...
    inline_keyboard = [
        [
            {"text": "✅gmgn", "url": "https://gmgn.ai/eth/token/" + tokenAddress},
        ], [
            ...
            {"text": "✅buy/sell 一键买卖", "url": "https://t.me/pepeboost_swap_bot?start"
...
def request_ok():
    # 获取所有的数据https://www.okx.com/priapi/v1/invest/activity/smart-money/token/page?pageNo=1&pageSize=10&duration=1&order=tokenTradingTime&chainId=1&txnSource=1&t=1729842400490
    url = (f"https://www.okx.com/priapi/v1/invest/activity/smart-money/token/page?pageNo=1&pageSize=10&duration=1"
           f"&order=tokenTradingTime&chainId=1&txnSource=1&t=1729842400490")
